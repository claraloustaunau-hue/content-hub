...
- Reel: la clienta real (con permiso) recibiendo el pedido y enviando su reseña por WhatsApp.
- Carrusel con reseñas reales como piezas de comunicación.
- Story testimonial: *"Desde que automatizamos las reviews, pasó esto..."* con un dato concreto.
...
- **Partners externos involucrados:** equipos de Shop the look y Revie (coordinación de licencia, onboarding y acceso a métricas).
...
2. Confirmación con los partners de apps externas (Shop the look y Revie) sobre el acceso gratuito.
